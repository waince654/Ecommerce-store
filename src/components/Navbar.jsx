    ...
    <div className="bg-white py-3 shadow-2xl">
      <div className="max-w-6xl mx-auto flex justify-between items-center">
        ...
        <div className="flex gap-7 items-center">
          ...
          {dropdown ? (
            <div
              className="w-[250px] h-max shadow-2xl z-50 bg-white fixed top-16 left-16 
          border-2 p-5 border-gray-100 rounded-md"
            >
              <h1 className="font-semibold mb-4 text-xl flex justify-between">
                Change Location{" "}
                <span onClick={toogleDropdown}>
                  {" "}
                  <CgClose />
                </span>
              </h1>
              <button
                onClick={getLocation}
                className="bg-blue-700 text-white px-3 py-1 rounded-md cursor-pointer hover:bg-blue-600"
              >
                Detect my Location
              </button>
            </div>
